...
namespace Ualmarti.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Departament d2 = new Departament { Name = "Garden" };
            Departament d3 = new Departament { Name = "Office" };
            Departament d4 = new Departament { Name ="Bedroom" };
